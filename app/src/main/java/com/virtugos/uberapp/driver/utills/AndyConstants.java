...
public class AndyConstants {
    public static final String ACTION_START_MAP_ACTIVITY = "com.virtugos.uberapp.driver" +
            ".MAPACTIVITY";

    // account: Elluminati16, project: taxi V3
    public static final String DIRECTION_API_KEY = "AIzaSyBnc_SyLcCSvzEEMEPxjQFgRPy1k3LT1Q0";//
    ...
    public static final String PREF_NAME = "Cab Anytime Driver";
    ...
    public static final int PERMISSION_CALL = 215;
    ...
    public static boolean isShowNoteDialog = false, isTokenExpired = false;
    // web service url constants
    public class ServiceType {

        //http://taxinew.taxinow.xyz/
//  http://192.168.0.38/taxianytime_latest/public/
        private static final String HOST_URL = "http://umovel.com.br/taxi/public/";
